...
update_card,delete_from_card,CategoryPage,Inpost_Billing,order_detail_user)
urlpatterns = [
        ...
        path('order_detail_user/<int:order_id>/',order_detail_user,name='order_detail_user'),
